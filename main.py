...
def attack(char_name: str, char_class: str) -> str:
    """Определяет количесвто урона при атаке."""
    """В зависимости от выбранного героя."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет количесвто блокировки урона при защите."""
    """В зависимости от выбранного героя."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применение суперсилы в зависимости от выбранного героя."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    defence — чтобы атаку противника
...
if __name__ == '__main__':
    """Вывол на экран приветсия. Запуск тренировки"""
    run_screensaver()
